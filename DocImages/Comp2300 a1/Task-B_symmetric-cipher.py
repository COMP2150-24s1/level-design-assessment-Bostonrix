...
# Subtask B.1 (2 marks): Write the corresponding code to answer the following questions. Report the answers as the answers of Task B.1 in the assignment answer template  
# (1). In the example demonstrated above, whether the plain text and the cipher text have the same length as we expect as a pair of plain text and cipher text? Why?
# (2). Select a position in the plain text, replace the character with a different one of your choice. Now, the two plain texts have one character difference. 
...
# Report the change you have made to the plain text and what the percentage of positions having different characters in the two pieces of cipher text is.
...
# After decrypt the file successfully, report the line 5 of the text file as the answers of Task B.2 in the assignment answer template.
...
# The cipher text file should be named with the format "<YourStudentID>_Task-B-3_cipher-text.txt", where <YourStudentID> should be replaced by your own student ID.
